	...
	void RecalculateVertices ()
	{
		...
		for (int i = 0; i < vertices.Length; i++)
		{
			...
			if(i == vertices.Length/2) {
				flare.transform.position = (vertices[i] + transform.position)*transform.parent.localScale.magnitude;
//				flare.transform.GetChild(0).position = (vertices[0] + transform.position)/transform.parent.localScale.magnitude;
//				flare.transform.GetChild(1).position = (vertices[vertices.Length-1] + transform.position)/transform.parent.localScale.magnitude;
			}
